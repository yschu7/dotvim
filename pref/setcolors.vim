...
function! s:SetColors(args)
  ...
  elseif a:args == 'my'
    let c1 = 'vividchalk desert oceandeep ir_black neverland2'
    let c2 = 'jellybeans neverness neverland2D underwater'
    let c3 = 'lucius molokai kkruby railscasts literal_tango blackboard'
    let c4 = 'fu darkZ wombat256 TomorrowNight'
    let s:mycolors = split(c1.' '.c2.' '.c3.' '.c4)
...
function! s:HourColor()
  ...
  let nowcolors = 'neverland morning desert evening neverlandD'
...
function! s:ChangeColor(args)
  ...
  endwhile
  call inputrestore()
  execute ':colorscheme '. s:cols[num]
endfunction
